...
var nextStep=function(e){$('[name*="method"]').removeClass("selected"),$(e).attr("class","selected"),$.get("https://pvp.btmt2.com/epay",{cc:country},function(a){if("sms"==$(e).val()){var t=a.data.modules.methods.sms[0].price,i=a.data.modules.methods.sms[0].lcurrency;$("#second_step").find(".select_price").html('<input type="radio" name="price" id="rb0" value="'+t+'" /><label for="rb0">'+t+" "+i+"</label>")}else $("#second_step").find(".select_price").html('<input type="radio" name="price" id="rb1" value="5.00" /><label for="rb1">500 coins - 5.00 EUR</label><input type="radio" name="price" id="rb2" value="10.00" /><label for="rb2">1100 coins - 10.00 EUR</label><input type="radio" name="price" id="rb3" value="15.00" /><label for="rb3">1650 coins - 15.00 EUR</label><input type="radio" name="price" id="rb4" value="20.00" /><label for="rb4">2200 coins - 20.00 EUR</label><input type="radio" name="price" id="rb5" value="50.00" /><label for="rb5">6000 coins - 50.00 EUR</label>')})};$("body").on("change",'.select_price input[name*="price"]',function(e){var a=$(this).val(),t=$("#first_step").find('[name*="method"].selected').val();$(".epay_content").html('<button href="javascript:;" data-fancybox="iframe" data-src="//paymentbox.e-payouts.com?uid=94&mid=230&ucode='+player+'?>&price='+a+"&pm="+t+'" data-type="iframe" id="activate_button">PAGAR</button>'),$("#wizard").steps("next")});